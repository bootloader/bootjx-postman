...
import com.boot.utils.CommonArrayUtils;
import com.boot.utils.CommonStringUtils;

public class EmailParser {

	static final Pattern SIG_PATTERN = Pattern
	...
	public Email parse(String emailText) {
		 ...
		 */
		CommonArrayUtils.reverse(lines);
		...
		for (String line : lines) {
			...
			line = CommonStringUtils.stripEnd(line, "\n");
			// Strip empty spaces at the end of the string
			line = CommonStringUtils.stripEnd(line, null);
	...
	protected Email createEmail(List<FragmentDTO> fragmentDTOs) {
		...
		for (FragmentDTO f : fragmentDTOs) {
			...
			String content = new StringBuilder(CommonStringUtils.join(f.lines, "\n")).toString();
	...
	private boolean isEmpty(FragmentDTO fragment) {
		return CommonStringUtils.join(fragment.lines, "").isEmpty();
	}
	...
	private boolean isQuoteHeader(List<String> paragraph) {
		...
		String content = new StringBuilder(CommonStringUtils.join(paragraph, "\n")).toString();
